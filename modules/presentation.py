            ...
            dbc.Collapse(
                dbc.Card(
                    dbc.CardBody(
                        [
                            html.H5(
                                "Histograma de Distribución de Frecuencias (Estado Final)",
                                className="card-title",
                            ),
                            html.H6(
                                "Muestra qué porcentaje de combinaciones ha aparecido 1 vez, 2 veces, etc. Ayuda a entender la 'rareza'.",
